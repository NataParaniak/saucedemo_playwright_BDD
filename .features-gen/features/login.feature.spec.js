...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":13,"pickleLine":9,"tags":[],"steps":[{"pwStepLine":14,"gherkinStepLine":10,"keywordType":"Context","textWithKeyword":"Given the user is on the SauceDemo login page","stepMatchArguments":[]},{"pwStepLine":15,"gherkinStepLine":11,"keywordType":"Action","textWithKeyword":"When the user enters blocked credentials","stepMatchArguments":[]},{"pwStepLine":16,"gherkinStepLine":12,"keywordType":"Action","textWithKeyword":"And the user clicks the Login button","stepMatchArguments":[]},{"pwStepLine":17,"gherkinStepLine":13,"keywordType":"Outcome","textWithKeyword":"Then the error message \"Epic sadface: Sorry, this user has been locked out.\" should be displayed","stepMatchArguments":[{"group":{"start":18,"value":"\"Epic sadface: Sorry, this user has been locked out.\"","children":[{"start":19,"value":"Epic sadface: Sorry, this user has been locked out.","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":18,"gherkinStepLine":14,"keywordType":"Outcome","textWithKeyword":"And user should remain on the login page","stepMatchArguments":[]}]},
  {"pwTestLine":21,"pickleLine":16,"tags":[],"steps":[{"pwStepLine":22,"gherkinStepLine":17,"keywordType":"Context","textWithKeyword":"Given the user is on the SauceDemo login page","stepMatchArguments":[]},{"pwStepLine":23,"gherkinStepLine":18,"keywordType":"Context","textWithKeyword":"And the user clicks the Login button","stepMatchArguments":[]},{"pwStepLine":24,"gherkinStepLine":19,"keywordType":"Outcome","textWithKeyword":"Then login error message \"Epic sadface: Username is required\" should be displayed","stepMatchArguments":[{"group":{"start":20,"value":"\"Epic sadface: Username is required\"","children":[{"start":21,"value":"Epic sadface: Username is required","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":25,"gherkinStepLine":20,"keywordType":"Outcome","textWithKeyword":"And user should remain on the login page","stepMatchArguments":[]}]},
]; // bdd-data-end